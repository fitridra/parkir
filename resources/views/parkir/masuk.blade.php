...
<body>
    ...
    <main class="container">
        ...
        @endif
        <form action="{{route('tambah_masuk')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
                <label for="no_pol" class="form-label">Nomor Polisi</label>
                <input type="text" class="form-control" name="no_pol" id="no_pol" placeholder="BD 1234 CC" required>
            </div>

            <div class="mb-3">
                <label for="jk" class="form-label">Jenis Kendaraan</label>
                <input type="text" class="form-control" id="jk" name="jenis_kendaraan" placeholder="Mini Bus" required>
            </div>
